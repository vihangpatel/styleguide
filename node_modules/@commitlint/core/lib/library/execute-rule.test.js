...
(0, _ava2.default)('does nothing without params', function (t) {
	return new Promise(function ($return, $error) {
		var actual;
		return Promise.resolve((0, _executeRule2.default)()).then(function ($await_1) {
			try {
				actual = $await_1;
				t.is(actual, null);
				return $return();
...
(0, _ava2.default)('returns plain config', function (t) {
	return new Promise(function ($return, $error) {
		var actual;
		return Promise.resolve((0, _executeRule2.default)(['name', 'config'])).then(function ($await_2) {
			try {
				actual = $await_2;
...
(0, _ava2.default)('unwraps promised config', function (t) {
	return new Promise(function ($return, $error) {
		var actual;
		return Promise.resolve((0, _executeRule2.default)(['name', Promise.resolve('config')])).then(function ($await_3) {
			try {
				actual = $await_3;
				t.deepEqual(actual, ['name', 'config']);
				return $return();
...
(0, _ava2.default)('executes config functions', function (t) {
	return new Promise(function ($return, $error) {
		var actual;
		return Promise.resolve((0, _executeRule2.default)(['name', function () {
			return 'config';
...
//# sourceMappingURL=execute-rule.test.js.map