...
(0, _ava2.default)('should return an array for empty input', function (t) {
	t.deepEqual((0, _toLines2.default)(), []);
});

(0, _ava2.default)('should return an array for null input', function (t) {
	t.deepEqual((0, _toLines2.default)(null), []);
});
