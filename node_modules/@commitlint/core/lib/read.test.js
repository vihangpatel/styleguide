...
(0, _ava2.default)('get history commit messages from shallow clone', function (t) {
	return new Promise(function ($return, $error) {
		var cwd, err;
		return Promise.resolve(_test.git.clone(_package2.default.repository.url, '--depth', '1')).then(function ($await_22) {
			try {
				cwd = $await_22;
				return Promise.resolve(t.throws((0, _read2.default)({ from: 'master', cwd }))).then(function ($await_23) {
					try {
						err = $await_23;
