...
function globsToFileList(cwd, includePatterns, excludePatterns, options) {
  ...
  var includeFiles = coalescePatterns((0, _core.toArray)(includePatterns), globOptions);
  var excludeFiles = coalescePatterns((0, _core.toArray)(excludePatterns), globOptions);
